...
def get_trend(var, sites_list, alpha_value, group, plot_graphs = True):
...
def get_subdaily_from_disagregation_factors(df, type_of_disagregator, var_value, name_file):
    df_subdaily = df
    ...
    df_subdaily.to_csv('Results/max_subdaily_{n}_{t}.csv'.format(n = name_file, t = type), index = False)
